...
const pedidos_has_produtoController = require("../controller/cliente_controller.js");

router.post("/", pedidos_has_produtoController.cadastrar);

router.get("/", pedidos_has_produtoController.listar);

router.get("/:id", pedidos_has_produtoController.buscarPorId);

router.put("/:id", pedidos_has_produtoController.atualizar);

router.delete("/:id", pedidos_has_produtoController.excluir);
