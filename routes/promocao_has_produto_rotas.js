...
const promocao_has_produtoController = require("../controller/promocao_has_produtocontroller.js");

router.post("/", promocao_has_produtoController.cadastrar);

router.get("/", promocao_has_produtoController.listar);

router.get("/:id", promocao_has_produtoController.buscarPorId);

router.put("/:id", promocao_has_produtoController.atualizar);

router.delete("/:id", promocao_has_produtoController.excluir);
