...
const avaliacao_produtos_has_produtosController = require("../controller/avaliacao_has_produto_controller.js");
...
router.get("/:id", avaliacao_produtos_has_produtosController.buscarPorId);
