...
function cadastrar(req, res) {
    ...
    if (
        carrinho.quantidade_produto == null ||
        carrinho.preco_total == null
    ) {

        return res.status(400).json({

            sucesso: false,
            mensagem: "Informe a quantidade e o preço total."
