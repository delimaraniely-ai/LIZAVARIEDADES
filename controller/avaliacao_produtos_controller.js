...
const avaliacaoProdutosModel = require("../model/avaliacao_produto_model");
...
function cadastrar(req, res) {
    ...
    if (
        ...
        return res.status(400).json({
            ...
            sucesso: false,
            mensagem: "Informe a data da avaliação e a nota."
    ...
    avaliacaoProdutosModel.cadastrar(
        avaliacao,
        (erro, resultado) => {
...
function buscarPorId(req, res) {
    ...
    avaliacaoProdutosModel.buscarPorId(
        id,
        (erro, resultado) => {
...
function atualizar(req, res) {
    ...
    avaliacaoProdutosModel.atualizar(
        id,
        avaliacao,
        (erro, resultado) => {
...
function excluir(req, res) {
    ...
    avaliacaoProdutosModel.excluir(
        id,
        (erro, resultado) => {
